 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://helloservice/", wsdlLocation = "http://localhost:8080/hellows/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://helloservice/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/hellows/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://helloservice/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloservice/", "HelloPort"), Hello.class, features);
    }
