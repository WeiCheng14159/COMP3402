...
public class PlayGamePage extends Page{
	...
	public PlayGamePage(ActionListener profile_btn_listener, ActionListener playgame_btn_listener, ActionListener leaderboard_btn_listener, ActionListener logout_btn_listener) {
